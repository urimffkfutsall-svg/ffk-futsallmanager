...
import EditorTeamPage from "./pages/EditorTeamPage";
import IndividualStatsPage from "./pages/IndividualStatsPage";
import FormacioniPage from "./pages/FormacioniPage";
